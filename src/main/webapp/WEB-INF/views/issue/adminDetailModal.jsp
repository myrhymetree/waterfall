        ...
        <!-- Modal body -->
                   <div class="modal-body" id="modal-body">
                        <div class="mt-4 row">
                            ...
                            <div class="col-4">
                                <select class="importance ms-auto" id="read-progressStatus" name="progressStatus" onfocus="this.value=''" required>
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col"><input type="date" id="read-createdDate" name="createdDate" onfocus="this.value=''" required></div>
                       
                            <div class="col-2 center"><label for="read-deadline">마감일</label></div>
                            <div class="col-4"><input type="date" id="read-deadline" name="deadline" onfocus="this.value=''" required></div>
                        </div>

                         <div class="mt-4 row">
                            <div class="col-2 center"><label>이슈 제기자</label></div>
                            <div class="col">
                            	<select class="importance ms-auto" id="register" name="registerNo" onfocus="this.value=''" required>
								</select>
                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-4">
	                            <select class="importance ms-auto" id="read-importance" name="importance" onfocus="this.value=''" required>
                       ...
                       <div class="mt-4 row" id="completedDateZone">
                        ...
                        <div class="mt-4 row">
			                ...
			                <div class="col-10"><textarea id="read-content" cols="80" rows="10" name="content" onfocus="this.value=''" required></textarea></div>
			            </div>
