...
<script src="${ pageContext.servletContext.contextPath }/js/scripts.js" />
<script
...
<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="index.html">Project Waterfall
			Service</a>
		<!-- Sidebar Toggle-->
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<div class="collapse" id="pagesCollapseAuth"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="login.html">직급관리</a> <a
							...
							<div class="menu-font2">
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="layout-static.html">공지사항</a> <a
										class="nav-link" href="layout-sidenav-light.html">회의록</a> <a
										class="nav-link" href="layout-sidenav-light.html">교육</a>
								</nav>
							</div>
						</div>
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
