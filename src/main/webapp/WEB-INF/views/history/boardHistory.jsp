	            ...
	            <div class="card-body">
	                <table id="datatablesSimple">
	                   <colgroup>
	                    ...
	                    <tbody>
	                    	<c:forEach var="board" items="${ requestScope.boardHistoryList }" varStatus="status">
		                        <tr>
		                            <td><c:out value="${ board.updatedDate }"/></td>
		                            <td><c:out value="${ board.categoryTypeNo }"/></td>
		                            <td><c:out value="${ board.projectNo }"/></td>
